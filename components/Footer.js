        ...
        <div className="flex justify-between text-white font-chillax pb-[160px] pt-[82px] container mx-auto">
          ...
          />
            ...
            <div className="flex flex-col">
                ...
                className="text-[32px] mb-8 cursor-pointer">Nique</motion.a>
                <motion.a 
                initial = {{opacity : 0 , x : 5}}
                whileInView = {{opacity : 1 , x : 0}}
                transition = {{duration : .5 , ease : 'easeOut' , delay : .3}}
                className="font-light text-sm">By Pawel Gola<br></br>Powered by Webflow
                </motion.a>
            </div>
            <div>
                ...
                <div className="flex flex-col gap-4">
                {
                    Pages.map((item , i) => (
                        ...
                        transition = {{duration : .5 , delay : i * .4}}
                        key={item.id}
                        href={item.link}
                        onClick={(e) => {
                        ...
                        >
                            <p className="text-gray-400 font-light hover:text-gray-100 cursor-pointer transition-all ease-in duration-75">{item.name}</p>
                        </motion.div>
                    ))
                }
                </div>
